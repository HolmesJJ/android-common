...
public class GameView extends LinearLayout {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mTitle = typeArray.getString(R.styleable.GameView_title);
        mIcon = typeArray.getDrawable(R.styleable.GameView_src);
        mBgColor = typeArray.getColor(R.styleable.GameView_bg_color, 0xFFFFFFFF);
